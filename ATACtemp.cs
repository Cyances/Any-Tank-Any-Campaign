...
namespace ATAC
{
    public class ATACMod : MelonMod
    {
        ...
        public static MelonPreferences_Entry<string> t72lemmod_replace;
        public static MelonPreferences_Entry<int> t72lemmod_chance;
        ...
        public override void OnInitializeMelon()
        {
            ...
            t72lemmod_replace = cfg.CreateEntry("T-72 LEM mod replacement", "T72ULEM");
            t72lemmod_chance = cfg.CreateEntry("T-72 LEM mod replacement chance", 100);
            ...
            t64a74_replace = cfg.CreateEntry("SA T-64A '74 replacement", "T64A74");
            t64a74_chance = cfg.CreateEntry("SA T-64A '74 replacement chance", 100);
            t64a79_replace = cfg.CreateEntry("SA T-64A '79 replacement", "T64A79");
            t64a79_chance = cfg.CreateEntry("SA T-64A '79 replacement chance", 100);
            t64a81_replace = cfg.CreateEntry("SA T-64A '81 replacement", "T64A81");
            t64a81_chance = cfg.CreateEntry("SA T-64A '81 replacement chance", 100);
            t64a_replace = cfg.CreateEntry("SA T-64A replacement", "T64B");
            t64a_chance = cfg.CreateEntry("SA T-64A replacement chance", 100);
            t64a84_replace = cfg.CreateEntry("SA T-64A '84 replacement", "T64A84");
            t64a84_chance = cfg.CreateEntry("SA T-64A '84 replacement chance", 100);
                ...
                if (campaignMission.Value)
                {
                    ...
                    switch (__result)
                    {
                        ...
                        case "T72UV1":
                            ...
                            break;
                        case "T72ULEM":
                            replace = t72lemmod_replace.Value;
                            chance = t72lemmod_chance.Value;
                            break;
                        case "T72M":
